...
ScrollReveal().reveal(".home-content h1, .about-image, .contacts", {origin: 'left'});
ScrollReveal().reveal(".home-content p, .about-content,", {origin: 'right'});

// Typed JavaScript
const typed = new Typed('.multiple-text', {
    strings: ['Frontend Developer!', 'Python Developer!', 'Backend Developer!'],
    typeSpeed: 100,
    backSpeed: 100, 
    backDelay: 1000, 
    loop: true,
...
const type = new Typed('.multiple-texts', {
    strings: ['Frontend Developer!', 'Python Developer!', 'Backend Developer!'],
    typeSpeed: 100,
    backSpeed: 100, 
    backDelay: 1000, 
...
document.querySelectorAll(".anchor").forEach(link => {
    ...
    const textToCopy = this.textContent; // get text inside the anchor
